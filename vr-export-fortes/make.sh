...
files="${files} vrintegracao/vo/interfaces/fortes/FortesESIVO.java"
files="${files} vrintegracao/vo/interfaces/fortes/FortesIESVO.java"
...
files="${files} vrintegracao/dao/interfaces/FortesDAO.java"
...
then
  ...
  jar cvfm fortes-plus-1.4.5.jar META-INF/MANIFEST.MF *
