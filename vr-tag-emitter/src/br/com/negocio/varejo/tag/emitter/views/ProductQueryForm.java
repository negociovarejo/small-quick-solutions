...
public class ProductQueryForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtTerm.setFont(txtTerm.getFont());
        ...
        productsTable.setFont(productsTable.getFont().deriveFont(productsTable.getFont().getSize()-1f));
        ...
        lblLine.setFont(lblLine.getFont().deriveFont(lblLine.getFont().getSize()-1f));
        lblLine.setText("Linha:");

        lblSelectedLine.setFont(lblSelectedLine.getFont().deriveFont(lblSelectedLine.getFont().getSize()-1f));
        ...
        btnQuery.setFont(btnQuery.getFont().deriveFont(btnQuery.getFont().getSize()-1f));
    ...
    {//GEN-HEADEREND:event_btnQueryActionPerformed
        ...
        products.forEach(product -> {
            ...
            row[0] = Long.toString(product.getId());
            row[1] = product.getDescription();
            row[2] = String.format(Locale.getDefault(), "%.2f", product.getPrice1()).replace(".", ",");
            model.addRow(row);
        });
